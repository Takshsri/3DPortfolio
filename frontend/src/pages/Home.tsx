...
import { ArrowUpRight, Code2, Github, Linkedin, Mail, ChevronDown } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-900 text-white selection:bg-blue-500/30 overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[95vh] px-4 sm:px-8 lg:px-12 py-16 max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto mb-12 px-4">
          <p className={`text-base sm:text-lg md:text-xl text-slate-300 max-w-3xl mx-auto text-center leading-relaxed transition-all duration-500 ${
            ...
            <span className={showMoreBio ? '' : 'hidden'}>
              {' '}Strong foundation in Data Structures & Algorithms (C++), experienced in modern backend architectures. 
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center mb-8">
          ...
          <div className="flex gap-3 p-3 lg:p-4 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl hover:shadow-2xl transition-all">
            <a href="https://github.com" className="p-3 text-slate-300 hover:text-white hover:bg-white/20 rounded-xl transition-all group" aria-label="GitHub">
              <Github size={20} />
            </a>
            <a href="https://linkedin.com" className="p-3 text-blue-400 hover:text-blue-300 hover:bg-blue-500/20 rounded-xl transition-all group" aria-label="LinkedIn">
              <Linkedin size={20} />
            </a>
            <a href="mailto:hello@ramya.dev" className="p-3 text-emerald-400 hover:text-emerald-300 hover:bg-emerald-500/20 rounded-xl transition-all group" aria-label="Email">
              <Mail size={20} />
            </a>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-8 lg:px-1 py-0 lg:py-32 relative">
